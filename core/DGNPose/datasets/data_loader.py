...
from .data_loader_online import DGNPose_Online_DatasetFromList
...
class DGNPose_DatasetFromList(Base_DatasetFromList):
...
def build_DGNPose_train_loader(cfg, dataset_names):
    ...
    if cfg.MODEL.POSE_NET.XYZ_ONLINE:
        dataset = DGNPose_Online_DatasetFromList(cfg, split="train", lst=dataset_dicts, copy=False)
    else:
        dataset = DGNPose_DatasetFromList(cfg, split="train", lst=dataset_dicts, copy=False)
...
def build_DGNPose_test_loader(cfg, dataset_name, train_objs=None):
    ...
    dataset = DGNPose_DatasetFromList(cfg, split="test", lst=dataset_dicts, flatten=False)
